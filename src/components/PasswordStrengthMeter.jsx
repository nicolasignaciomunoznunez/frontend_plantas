...
const PasswordCriteria = ({ password }) => {
	const criteria = [
		...
		{ label: "Contiene una mayuscula", met: /[A-Z]/.test(password) },
		{ label: "Contiene una minisucula", met: /[a-z]/.test(password) },
		{ label: "Contiene numeros", met: /\d/.test(password) },
		{ label: "Contiene un caracter especial", met: /[^A-Za-z0-9]/.test(password) },
	];
